...
public class AccesoDatos{
    ...
    public void crearBaseDeDatos(){
        try (Connection cnTemp= DriverManager.getConnection(URL_ROOT, DB_NAME, USER, PASSWORD); Statement st = cnTemp.createStatement()){
    ...
    private void mostrarDatosCoches(){
    ...
    private void modificarCoche(String matricula, int precio){
    ...
    public void insertarCoche(String matricula, String marca, int precio, String dni){
        try{
            String check = "SELECT * FROM Propietarios WHERE DNI = ?";
    ...
    public void mostrarPropietarioYCoches(String dni) throws SQLException{
        ...
        try (PreparedStatement pst = conexion.prepareStatement(sql)){
            ...
            while (rs.next()){
                // Si se ejecuta la consulta implica que existe el propietario, por tanto el booleano "propietarioExiste" pasa a ser verdadero.
                propietarioExiste = true;

                    // Si existe el propietario y el valor de la variable "tieneCoches" es "true" pasa al condicional "if" como verdadero.
